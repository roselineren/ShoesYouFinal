...
namespace OnlineShop.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult ProductDetail(int? id)
        {
            ...
            products = HttpContext.Session.Get<List<Produit2>>("products");
            if (products == null)
            {
                products = new List<Produit2>();
            }
        ...
        {
            List<Produit2> products = HttpContext.Session.Get<List<Produit2>>("products");
            if (products != null)
            {
